	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				success: '*[💯] Sucesso...*',
				error: {
					stick: ' *[⚠️]Foi mal ai,não tive sucesso ao fazer a figurinha*',
			...
			premium = [
			"557391442763@s.whatsapp.net","556194558701@s.whatsapp.net","556193845817@s.whatsapp.net","558581936821@s.whatsapp.net","553186547312@s.whatsapp.net","5516992859903@s.whatsapp.net"//GANTI NOMOR YAG MAU DI PREM, GABISA NYIMPEN DI DATABASE!!
			]
...
// akhir encrypt & decrypt Fitur
         ...
         case 'msc6':
                    ...
                    break
        case 'msc7':
                    tujuh = fs.readFileSync('./assets/AUD-202104010-WA1057.mp3');
                    client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
        case 'msc8':
                    tujuh = fs.readFileSync('./assets/AUD-202104010-WA1068.mp3');
                    client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
				default:
                  ...
                  reply(`Desculpe man *${pushname2}*, Comando *${prefix}${command}* comando nn registrado no menu! pfv chame o bot novamente *${prefix}menu!*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[CREITMBOT]','Yellow'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
			console.log('Error : %s', color(e, 'yellow'))
