...
~> Ecchi : *${ecch()}*
~> Titulo em japones : *${title}*
~> Soletre o título : *${title_romaji}*
~> Titulo em ingles : *${title_english}*
~> Episodio : *${episode}*
~> Temporada  : *${season}*`});
	} catch (e) {
		console.log(e)
...
const simih = async (text) => {
	try {
		...
		return  'não sei do que está falando, irmã da língua estrangeira?'
	}
}
...
const banner = cfonts.render(('CREITIM|BOT|V2'), {
    font: '3d',
    color: 'candy',
    align: 'center',
